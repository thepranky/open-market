...
| ✅ 5.22b | DOJ case-index scraper | new `scrape_us_doj_index.py`, fixtures | DOJ litigation/decree listings need repeatable discovery | ✅ Done — [spec](docs/specs/2026-06-30-us-doj-case-index-scraper.md): DOJ Civil Merger scraper fetches listing/detail pages, skips rows without true disposition dates, and emits CaseIndex-shaped dry-run/output records; no reviewed YAML batch |
