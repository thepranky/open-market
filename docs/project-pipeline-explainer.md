...
| **7**    | **Case coverage** ← Next        | Expand from 7 cases to a useful seed corpus, starting with 3 clean EC Phase I decisions in new sectors (fintech, digital comms, retail/e-commerce); target 50–100 cases | **Human + ChatGPT + Claude** — human selects/prioritises cases; ChatGPT assists research triage; Claude improves batch ingestion | The product only becomes useful once cross-case comparison works                                                  |
