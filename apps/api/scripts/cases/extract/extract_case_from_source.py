...
Usage:
    ...
    .venv/bin/python scripts/cases/extract/extract_case_from_source.py \\
...
# cross-bucket flat siblings live in integrity/ (check_source_integrity, repair_source_passages)
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "integrity"))
...
_CASES_DIR = Path(__file__).resolve().parents[5] / "data" / "cases"
_DRAFTS_DIR = Path(__file__).resolve().parents[5] / "data" / "drafts"
...
_DEBUG_DIR = Path(__file__).resolve().parents[5] / "data" / "source_text" / "debug"
