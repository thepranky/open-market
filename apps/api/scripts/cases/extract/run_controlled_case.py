...
def _script(name: str) -> str:
    # name is bucket-qualified (e.g. "extract/ingest_case.py") relative to scripts/cases/
    return str(_SCRIPTS_DIR.parent / name)
...
def stage_plan_coverage(
    ...
    *,
    ...
    cmd = [
        _python(), _script("extract/plan_coverage.py"),
        "--case-id", case_id,
...
def stage_extract(
    ...
    *,
    ...
    for focus in focuses:
        cmd = [
            _python(), _script("extract/ingest_case.py"),
            "--case-id", case_id,
            "--focus", focus,
        ]
...
def stage_merge_drafts(
    ...
    *,
    ...
    cmd = [
        _python(), _script("extract/merge_drafts.py"),
        "--case-id", case_id,
...
def stage_check_readiness(
    ...
    *,
    ...
    cmd = [
        _python(), _script("review/check_review_readiness.py"),
        "--case-id", case_id,
        "--packet",
...
def write_run_report(
    ...
    if result.status == READY:
        ...
        lines += [
            ...
            f"    python apps/api/scripts/cases/extract/run_controlled_case.py --case-id {result.case_id} [original flags]",
        ]
    else:
        lines += [
