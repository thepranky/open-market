...
Usage:
    ...
    .venv/bin/python scripts/cases/extract/plan_extraction_ranges.py \\
...
# cross-bucket flat sibling: repair_source_passages lives in integrity/
...
class ProbeWindow:
    ...
    def command(self, case_id: str, suffix_index: int) -> str:
        ...
        return (
            f"apps/api/.venv/bin/python apps/api/scripts/cases/extract/ingest_case.py"
            f" --case-id {case_id}"
            f" --focus {self.focus}"
