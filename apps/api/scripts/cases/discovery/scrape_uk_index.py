#!/usr/bin/env python3
"""
scrape_uk_index.py — Populate data/case_index/uk/ from the GOV.UK content API.
...
Usage:
    python apps/api/scripts/cases/discovery/scrape_uk_index.py [--dry-run] [--limit N] [--overwrite]
