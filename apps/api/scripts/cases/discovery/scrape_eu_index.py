...
Usage:
    python apps/api/scripts/cases/discovery/scrape_eu_index.py --from-date 2020-01-01 --to-date 2023-12-31
    python apps/api/scripts/cases/discovery/scrape_eu_index.py --from-date 2023-01-01 --dry-run
    python apps/api/scripts/cases/discovery/scrape_eu_index.py --limit 50 --dry-run  # quick test
"""
