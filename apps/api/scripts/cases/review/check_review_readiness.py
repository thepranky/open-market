...
# cross-bucket flat sibling: pipeline_profile lives in extract/
sys.path.insert(0, str(_API_DIR / "scripts" / "cases" / "extract"))
...
def write_review_packet(
    ...
    if errors:
        ...
        lines.append("  READY — no errors or warnings. Run run_case_promotion.py.")
    lines.append("")
