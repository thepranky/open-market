...
Usage:
    ...
    apps/api/.venv/bin/python apps/api/scripts/cases/promote_draft_to_canonical.py \\
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    print("  apps/api/.venv/bin/python apps/api/scripts/cases/validate_cases.py")
    print("  apps/api/.venv/bin/python apps/api/scripts/cases/check_source_integrity.py --no-cache")
