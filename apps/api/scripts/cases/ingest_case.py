...
Usage (from repo root):
    python apps/api/scripts/cases/ingest_case.py \\
    ...
    *,
    ...
    if blocking:
        ...
        lines += [
            ...
            f"{step + 3}. Run `python apps/api/scripts/cases/validate_cases.py` after canonical promotion.",
            f"{step + 4}. Run `python apps/api/scripts/cases/check_source_integrity.py --no-cache` as final gate.",
        ]
    lines.append("")
